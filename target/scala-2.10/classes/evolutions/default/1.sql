...
create table branch_table (
  ...
  done_at                   datetime,
  employee_id               bigint,
  constraint pk_branch_table primary key (id))
;
...
alter table branch_table add constraint fk_branch_table_employee_2 foreign key (employee_id) references employee (id) on delete restrict on update restrict;
create index ix_branch_table_employee_2 on branch_table (employee_id);
...
alter table faculty add constraint fk_faculty_branchTable_12 foreign key (branch_table_id) references branch_table (id) on delete restrict on update restrict;
create index ix_faculty_branchTable_12 on faculty (branch_table_id);
